...
class Ghost : public Creature
{
	...
	int startX, startY, startDestX, startDestY; // start locations

	const float MOVE_SPEED = 70; // pixels per second
...
public:
	...
	void reset(); // reset position and destination

	void move(float elapsed); // move
